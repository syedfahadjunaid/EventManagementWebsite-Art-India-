      ...
      {!responseGetPages.isLoading && (
        <div className='diwalibrussels'>
          <div className='breadcreams'>
            ...
            /<p>{responseGetPages?.data[7]?.PagesTitle}</p>
          </div>
          ...
          >
            <video
              src={`${process.env.React_App_Base_Image_Url}${responseGetPages?.data[7]?.PagesBannerVideo}`}
              muted
              autoPlay
              loop
          ...
          <div className='diwalibrussels_content'>
            <div className='diwalibrussels_content_left'>
              <p>{parse(responseGetPages?.data[7]?.PagesDescription)}</p>
              {/* <p>
            ...
            <div className='diwalibrussels_content_right'>
              <img
                src={responseGetPages?.data[7]?.PagesImg?.map((data) => {
          ...
          <div className='diwalibrussels_images'>
            <div className='diwalibrussels_images_row1'>
              {responseGetPages?.data[7]?.PagesGallary?.map((image, index) => {
                return (
                  <img
                    key={index}
          ...
          <video
            src={`${process.env.React_App_Base_Image_Url}${responseGetPages?.data[7]?.PagesVideo}`}
            muted
            autoPlay
            loop
            style={{
...
// import React from "react";
// import "./MusicConservatory.css";
// import { Link } from "react-router-dom";
// import img from "../imges/Rectangle 118.png";
// import DiwaliBrusselCard from "../Layout/DiwaliBrusselCard/DiwaliBrusselCard";
// import img2 from "../imges/music/image 90.jpg";
// import img3 from "../imges/music/image 91.jpg";
// import img4 from "../imges/music/image 94.png";
// import img5 from "../imges/music/CF2016lowres-57_1920w.jpg";
// import img6 from "../imges/music/course-foundation.jpg";
// import img7 from "../imges/Rectangle 104.png";
// import img8 from "../imges/Rectangle 103.png";
// import img9 from "../imges/Rectangle 102.png";
// import HeadImage from "../Layout/HeadImage/HeadImage";
...
//           <p>Home</p>{" "}
//         </Link>{" "}
//         /<p>Music Conservatory</p>
//       </div>
//       <div className="musicconservatory_banner">
...
// export default MusicConservatory;
