      ...
      {!responseGetPages.isLoading && (
        <div className='diwalibrussels'>
          <div className='breadcreams'>
            ...
            /<p>{responseGetPages?.data[1]?.PagesTitle}</p>
          </div>
          ...
          >
            <video
              src={`${process.env.React_App_Base_Image_Url}${responseGetPages?.data[1]?.PagesBannerVideo}`}
              muted
              autoPlay
              loop
          ...
          <div className='diwalibrussels_content'>
            <div className='diwalibrussels_content_left'>
              <p>{parse(responseGetPages?.data[1]?.PagesDescription)}</p>
              {/* <p>
            ...
            <div className='diwalibrussels_content_right'>
              <img
                src={responseGetPages?.data[1]?.PagesImg?.map((data) => {
          ...
          <div className='diwalibrussels_images'>
            <div className='diwalibrussels_images_row1'>
              {responseGetPages?.data[1]?.PagesGallary?.map((image, index) => {
                return (
                  <img
                    key={index}
          ...
          <video
            src={`${process.env.React_App_Base_Image_Url}${responseGetPages?.data[1]?.PagesVideo}`}
            muted
            autoPlay
            loop
            style={{
...
// import React from "react";
// import { Link } from "react-router-dom";
// import img from "../imges/yoga fest/sdgsgd.jpg";
// import DiwaliBrusselCard from "../Layout/DiwaliBrusselCard/DiwaliBrusselCard";
// import img5 from "../imges/yoga fest/woman-meditating-table-park_23-2147648590.jpg";
// import img2 from "../imges/yoga fest/wanderlust-good.jpg";
// import img4 from "../imges/yoga fest/Wanderlust-Yoga-Festival-1-800x450.jpg";
// import img3 from "../imges/yoga fest/wanderlust.jpg";
// import img6 from "../imges/yoga fest/yogafestival.jpg";
// import img7 from "../imges/Rectangle 104.png";
// import img8 from "../imges/Rectangle 103.png";
// import img9 from "../imges/Rectangle 102.png";
// import img10 from "../imges/yoga fest/yoga.png";
// import HeadImage from "../Layout/HeadImage/HeadImage";
// import Blogcard from "../BlogCard/Blogcard";
// import NewsLetter from "../Layout/NewsLetter/NewsLetter";
// import Footer from "../Footer/Footer";
...
//         <p>Video</p>
//       </div>
//       <div className="yogafest_video"></div>
//       <div className="diwalibrussels_know_more">
//         <HeadImage />
//         <h3>Know More</h3>
//         <div className="diwalibrussels_know_more_card">
