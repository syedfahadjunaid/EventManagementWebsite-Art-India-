      ...
      {!responseGetPages.isLoading && (
        <div className='diwalibrussels'>
          <div className='breadcreams'>
            ...
            /<p>{responseGetPages?.data[4]?.PagesTitle}</p>
          </div>
          ...
          >
            <video
              src={`${process.env.React_App_Base_Image_Url}${responseGetPages?.data[4]?.PagesBannerVideo}`}
              muted
              autoPlay
              loop
          ...
          <div className='diwalibrussels_content'>
            <div className='diwalibrussels_content_left'>
              <p>{parse(responseGetPages?.data[4]?.PagesDescription)}</p>
              {/* <p>
            ...
            <div className='diwalibrussels_content_right'>
              <img
                src={responseGetPages?.data[4]?.PagesImg?.map((data) => {
          ...
          <div className='diwalibrussels_images'>
            <div className='diwalibrussels_images_row1'>
              {responseGetPages?.data[4]?.PagesGallary?.map((image, index) => {
                return (
                  <img
                    key={index}
          ...
          <video
            src={`${process.env.React_App_Base_Image_Url}${responseGetPages?.data[4]?.PagesVideo}`}
            muted
            autoPlay
            loop
            style={{
...
// import React from "react";
// import { Link } from "react-router-dom";
// import img from "../imges/Performance/pexels-photo-13191043.jpg";
// import DiwaliBrusselCard from "../Layout/DiwaliBrusselCard/DiwaliBrusselCard";
// import img2 from "../imges/Performance/musicial-music-live-band-performing-stage-with-different-lights-beautiful-blonde-vocal-singer-girl.jpg";
// import img3 from "../imges/Performance/music-and-dance-festivals-at-tourist-destinations-signal-the-arrival-of-music-tourism-in-india.jpg";
// import img4 from "../imges/Performance/pexels-photo-1755087.jpeg";
// import img5 from "../imges/Performance/concert-971034_1280.jpg";
// import img6 from "../imges/Performance/Corporate-Events-and-Artist-Performance.jpg";
// import img7 from "../imges/Performance/pexels-photo-1540406.jpeg";
// import img8 from "../imges/Rectangle 103.png";
// import img9 from "../imges/Rectangle 102.png";
// import HeadImage from "../Layout/HeadImage/HeadImage";
// import Blogcard from "../BlogCard/Blogcard";
...
//         /<p>Performance</p>
//       </div>
//       <div className="performance_banner">
//         <h3>Performance</h3>
...
//         </div>
//         <div className="diwalibrussels_content_right">
//           <img src={img} alt="banner" className=" performance_img" />
//         </div>
//       </div>
//       <div className="diwalibrussels_heading">
//         <p>Events</p>
...
//         <p>Video</p>
//       </div>
//       <div className="performance_video"></div>
//       <div className="diwalibrussels_know_more">
//         <HeadImage />
//         <h3>Know More</h3>
//         <div className="diwalibrussels_know_more_card">
