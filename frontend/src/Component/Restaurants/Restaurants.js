      ...
      {!responseGetPages.isLoading && (
        <div className='diwalibrussels'>
          <div className='breadcreams'>
            ...
            /<p>{responseGetPages?.data[6]?.PagesTitle}</p>
          </div>
          ...
          >
            <video
              src={`${process.env.React_App_Base_Image_Url}${responseGetPages?.data[6]?.PagesBannerVideo}`}
              muted
              autoPlay
              loop
          ...
          <div className='diwalibrussels_content'>
            <div className='diwalibrussels_content_left'>
              <p>{parse(responseGetPages?.data[6]?.PagesDescription)}</p>
              {/* <p>
            ...
            <div className='diwalibrussels_content_right'>
              <img
                src={responseGetPages?.data[6]?.PagesImg?.map((data) => {
          ...
          <div className='diwalibrussels_images'>
            <div className='diwalibrussels_images_row1'>
              {responseGetPages?.data[6]?.PagesGallary?.map((image, index) => {
                return (
                  <img
                    key={index}
          ...
          <video
            src={`${process.env.React_App_Base_Image_Url}${responseGetPages?.data[6]?.PagesVideo}`}
            muted
            autoPlay
            loop
            style={{
...
// import { Link } from "react-router-dom";
// import img from "../imges/resturant/image 45.jpg";
// import DiwaliBrusselCard from "../Layout/DiwaliBrusselCard/DiwaliBrusselCard";
// import img2 from "../imges/resturant/image 65.jpg";
// import img3 from "../imges/resturant/image 90.jpg";
// import img4 from "../imges/resturant/orchestra-6312709_1280.jpg";
// import img5 from "../imges/resturant/pexels-chan-walrus-941861.jpg";
// import img6 from "../imges/resturant/pexels-fu-zhichao-587741.jpg";
// import img7 from '../imges/Rectangle 104.png'
// import img8 from '../imges/Rectangle 103.png'
// import img9 from '../imges/Rectangle 102.png'
// import HeadImage from "../Layout/HeadImage/HeadImage";
...
//         /<p>Restaurants</p>
//       </div>
//       <div className="restaurants_banner">
//         <h3>Restaurants</h3>
//         <Link to="/booknow"> Book Now</Link>
//       </div>
//       <div className="diwalibrussels_content">
...
//         <p>Video</p>
//       </div>
//       <div className="resturants_video"></div>
//       <div className="diwalibrussels_know_more">
//         <HeadImage />
//         <h3>Know More</h3>
//         <div className="diwalibrussels_know_more_card">
