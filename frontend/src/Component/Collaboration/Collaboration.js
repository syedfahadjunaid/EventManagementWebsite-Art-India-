      ...
      {!responseGetPages.isLoading && (
        <div className='diwalibrussels'>
          <div className='breadcreams'>
            ...
            /<p>{responseGetPages?.data[5]?.PagesTitle}</p>
          </div>
          ...
          >
            <video
              src={`${process.env.React_App_Base_Image_Url}${responseGetPages?.data[5]?.PagesBannerVideo}`}
              muted
              autoPlay
              loop
          ...
          <div className='diwalibrussels_content'>
            <div className='diwalibrussels_content_left'>
              <p>{parse(responseGetPages?.data[5]?.PagesDescription)}</p>
              {/* <p>
            ...
            <div className='diwalibrussels_content_right'>
              <img
                src={responseGetPages?.data[5]?.PagesImg?.map((data) => {
          ...
          <div className='diwalibrussels_images'>
            <div className='diwalibrussels_images_row1'>
              {responseGetPages?.data[5]?.PagesGallary?.map((image, index) => {
                return (
                  <img
                    key={index}
          ...
          <video
            src={`${process.env.React_App_Base_Image_Url}${responseGetPages?.data[5]?.PagesVideo}`}
            muted
            autoPlay
            loop
            style={{
...
// import React from "react";
// import { Link } from "react-router-dom";
// import img from "../imges/collabration/pexels-photo-3277806.jpeg";
// import DiwaliBrusselCard from "../Layout/DiwaliBrusselCard/DiwaliBrusselCard";
// import img2 from "../imges/collabration/pexels-photo-5676744.jpeg";
// import img3 from "../imges/collabration/pexels-photo-7793692.jpeg";
// import img4 from "../imges/collabration/pexels-photo-8069408.jpg";
// import img5 from "../imges/collabration/pexels-photo-7688161.jpeg";
// import img6 from "../imges/collabration/pexels-photo-7551506.jpeg";
// import img7 from "../imges/collabration/pexels-photo-9488839.jpg";
// import img8 from "../imges/Rectangle 103.png";
// import img9 from "../imges/Rectangle 102.png";
// import HeadImage from "../Layout/HeadImage/HeadImage";
// import Blogcard from "../BlogCard/Blogcard";
...
//           /<p>Collaboration</p>
//         </div>
//         <div className="collaboration_banner">
//           <h3>Collaboration</h3>
//           <Link to="/booknow"> Book Now</Link>
//         </div>
//         <div className="diwalibrussels_content">
...
//               For we know what they are capable of, The atrocities they have
//               done; We will never forget their injustices And their merciless
//               conquests, their heinous crimes and ploys; We shall never suffer
//               their unwelcome invasions.
//             </p>
//             <p>
//               Nor forgive their sinful oppresion of us; We shall always remember
//               their acts of wickedness, Their enmity and disdain for all
//               mankind; With courage and fortitude we shall not shirk from our
//               duty, To expel them and their evils from this world; Our feud
//               shall continue until the day The adversary is vanquished and the
//               truth wins out.
//             </p>
//             <button
//               bgcolor="#E68639"
...
//           </div>
//           <div className="diwalibrussels_content_right">
//             <img src={img} alt="banner" className="collaboration_img" />
//           </div>
//         </div>
//         <div className="diwalibrussels_heading">
//           <p>Events</p>
