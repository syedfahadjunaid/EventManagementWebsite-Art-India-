      ...
      {!responseGetPages.isLoading && (
        <div className='diwalibrussels'>
          <div className='breadcreams'>
            ...
            /<p>{responseGetPages?.data[3]?.PagesTitle}</p>
          </div>
          ...
          >
            <video
              src={`${process.env.React_App_Base_Image_Url}${responseGetPages?.data[3]?.PagesBannerVideo}`}
              muted
              autoPlay
              loop
          ...
          <div className='diwalibrussels_content'>
            <div className='diwalibrussels_content_left'>
              <p>{parse(responseGetPages?.data[3]?.PagesDescription)}</p>
              {/* <p>
            ...
            <div className='diwalibrussels_content_right'>
              <img
                src={responseGetPages?.data[3]?.PagesImg?.map((data) => {
          ...
          <div className='diwalibrussels_images'>
            <div className='diwalibrussels_images_row1'>
              {responseGetPages?.data[3]?.PagesGallary?.map((image, index) => {
                return (
                  <img
                    key={index}
          ...
          <video
            src={`${process.env.React_App_Base_Image_Url}${responseGetPages?.data[3]?.PagesVideo}`}
            muted
            autoPlay
            loop
            style={{
